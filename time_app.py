...
with st.expander("Futher Research"):
    ...
    st.write('Advice #2: Every time you switch meetings, there is a tax your brain pays to get focused on the next task. Try to group your meetings into blocks.', unsafe_allow_html=False)
    st.image("images/outlook_cal.png", caption="A random person's outlook calendar. Source: Outlook")
    st.write('Advice #3: Remember to takes breaks, maybe go for a walk outside and exercise. This will increase your energy and productivity levels in the long run.', unsafe_allow_html=False)
